...
/**
 * Sequelize model contains all necessary methods defined in SequelizeModel class.*
...
class SequelizeModel extends Sequelize.Model {
  ...
  /**
   * Method defined in SequelizeModel and here it is basically an alias for findByPk
   * @param  {...any} params
   */
