...
export default class Repository {
  /**
   * Create instance with the data model of SequelizeModel type.
   * @param {SequelizeModel} model Data model used in repository.
   * @param schemes Schemes used in this repository for sanitizing data.
   */
  constructor(model, schemes = {}, dbConnection) {
    this.model = model;
